...
Plum table modification methods are 4× slower than loleris's Replica without nested plums or server-side events listeners, and ~10× slower traversing nested plums and server-side event listeners.
