...
Plums does much more to account for nested sub-plums and server-side event listeners, which can slow down method calls to ~10x slower than that algorithm.
